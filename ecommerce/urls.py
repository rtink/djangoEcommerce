...
urlpatterns = [
    ...
    path(r'billing/payment-method/', payment_method_view, name='billing_payment_method'),
    path(r'billing/payment-method/create/', payment_method_createview, name='billing_payment_method-endpoint'),
